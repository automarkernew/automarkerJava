...
public class YoloTaggingService {
    ...
    public void tagging(YoloTaggingTagReq req){
        ...
        //保存txt文件地址
        String txtUrl = minioLocalUrl + "/txt/" + videoInformation.getVideoId();
            ...
            if(file.isFile() && file.exists()){ //判断文件是否存在
                ...
                while((lineTxt = bufferedReader.readLine()) != null){
                    ...
                    if(!videoInformation.getSensorType().equals(SensorTypeEnum.VISIBLE.getState()) &&
                        ...
                        targetTrackT.setCoordinateFileUrl(minioLocalUrl + "/txt/" + videoInformation.getVideoId() + "/detect.txt");
                        targetTrackT.setMotImgUrl(minioLocalUrl + "/motimg/" + videoInformation.getVideoId());
    ...
    public YoloTaggingCreateRsp create(YoloTaggingCreateReq req){
        ...
        //文件地址
        String txtPath = minioLocalUrl + "/txt/" + req.getVideoId() + "/detect.txt";
    ...
    public void update(YoloTaggingUpdateReq req){
        ...
        //文件地址
        String txtPath = minioLocalUrl + "/txt/" + videoInformation.getVideoId() + "/detect.txt";
    ...
    public List<YoloTaggingGetThumbnailRsp> getThumbnail(YoloTaggingGetThumbnailReq req){
        ...
        for(TargetTrackT targetTrackT : targetTrackTs){
            ...
            if(videoInformation.getTagStatus().equals(TagStatusEnum.F.getState())) {
                ...
                yoloTaggingGetThumbnailRsp.setImageUrl("/img/" + videoInformation.getVideoId() + '/');
